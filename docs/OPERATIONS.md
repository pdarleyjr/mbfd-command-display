...
| Old app shell persists after deploy | Legacy service worker/browser cache | Reload once; `/sw.js` now clears old Workbox caches and unregisters. If needed visit `/cache-bust` or `?cache-bust=1` |
